...
class Pugbot(irc.bot.SingleServerIRCBot):
    def __init__(self, config):
        super(Pugbot, self).__init__([(config["server"], config["port"])],
        ...
        self.Q = []
        self.maps = ["abbey", "algiers", "austria", "bohemia", "casa", "docks",
                     "dressingroom", "eagle", "elgin", "kingdom",
                     "kingdom_rc6", "mandolin", "prague", "riyadh", "sanc",
                     "snoppis", "subway", "swim", "thingley", "tunis",
                     "turnpike", "uptown"]
        self.votes = {}
    ...
    def cmd_maps(self, issuedBy, data):
        ...
        self.say("maps: {0}".format(", ".join(self.maps)))
